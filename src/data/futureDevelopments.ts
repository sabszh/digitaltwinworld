...
export const futureDevelopments: FutureDevelopment[] = [
  ...
  development("ai-detects-burnout", "AI kan opdage tegn på stress og udbrændthed gennem almindeligt arbejde", ["AI og beslutninger", "Arbejde", "Sundhed og bioteknologi"], { unsuitableRoles: ["Barn"] }),
  ...
  development("robots-dangerous-work", "Robotter kan udføre det meste farlige fysiske arbejde i miner, brande og katastrofeområder", ["Robotter og autonome systemer", "Arbejde"], { unsuitableRoles: ["Barn"] }),
  ...
  development("humans-supervise-ai", "Mange medarbejdere fører primært tilsyn med arbejde, som AI udfører", ["Arbejde", "AI og beslutninger"], { unsuitableRoles: ["Barn"] }),
  development("many-career-switches", "Det er normalt at skifte fag flere gange gennem arbejdslivet med korte intensive uddannelsesforløb", ["Arbejde", "Uddannelse"], { unsuitableRoles: ["Barn"] }),
  development("agents-find-work", "AI-agenter kan finde opgaver og jobs og søge dem på menneskers vegne", ["Arbejde", "AI og beslutninger"], { unsuitableRoles: ["Barn"] }),
  ...
  development("work-measured-continuously", "Arbejdsindsats kan vurderes gennem løbende digitale spor fra det daglige arbejde", ["Arbejde", "Data, identitet og privatliv"], { unsuitableRoles: ["Barn"] }),
  development("remote-physical-work", "Specialiseret fysisk arbejde kan udføres globalt på afstand gennem robotter", ["Arbejde", "Robotter og autonome systemer"], { unsuitableRoles: ["Barn"] }),
  development("humans-liable-for-ai", "Mennesker kan være personligt ansvarlige for beslutninger, som en AI har foreslået og udført", ["Arbejde", "AI og beslutninger"], { unsuitableRoles: ["Barn"] }),
  ...
  development("tiny-agent-organisations", "Organisationer kan være meget små, fordi autonome agenter udfører koordinering, økonomi og drift", ["Arbejde", "AI og beslutninger"], { suitableRoles: ["Arbejdsgiver", "Medarbejder", "Fagperson", "Beslutningstager"], unsuitableRoles: ["Barn"] }),
  ...
  development("dynamic-energy-budgets", "Husholdninger kan have energibudgetter, der ændrer sig med vejr, produktion og fælles behov", ["Klima, energi og ressourcer"], { unsuitableRoles: ["Barn"] }),
  ...
  development("continuous-local-participation", "Lokal demokratisk deltagelse kan foregå løbende digitalt i stedet for kun ved valg og møder", ["Offentlige systemer og demokrati", "Data, identitet og privatliv"], { unsuitableRoles: ["Barn"] }),
  ...
  development("needs-before-application", "Behov for offentlig hjælp kan opdages, før personen selv søger om den", ["Offentlige systemer og demokrati", "AI og beslutninger", "Data, identitet og privatliv"], { unsuitableRoles: ["Barn"] }),
